...
const solution = [
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  traversePreOrderRecursive(node = this.root) {' },
  { stage: 0, text: '    if (!node) {' },
  { stage: 0, text: '      return;' },
  { stage: 0, text: '    }' },
  { stage: 0, text: '    this.callback(node.value);' },
  { stage: 0, text: '    this.traversePreOrderRecursive(node.left);' },
  { stage: 0, text: '    this.traversePreOrderRecursive(node.right);' },
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '}' },
  { stage: 0, text: '' },
