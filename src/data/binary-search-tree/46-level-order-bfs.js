...
const solution = [
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  traverseLevelOrderBfs(node = this.root) {' },
  { stage: 0, text: '    const queue = [];' },
  { stage: 0, text: '    if (!node) {' },
  { stage: 0, text: '      return;' },
  { stage: 0, text: '    }' },
  { stage: 0, text: '    queue.push(node);' },
  { stage: 0, text: '    while (queue.length) {' },
  { stage: 0, text: '      const temp = queue.shift();' },
  { stage: 0, text: '      this.callback(temp.value);' },
  { stage: 0, text: '      if (temp.left) {' },
  { stage: 0, text: '        queue.push(temp.left);' },
  { stage: 0, text: '      }' },
  { stage: 0, text: '      if (temp.right) {' },
  { stage: 0, text: '        queue.push(temp.right);' },
  { stage: 0, text: '      }' },
  { stage: 0, text: '    }' },
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
