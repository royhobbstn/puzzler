...
const solution = [
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  getParentIndex(childIndex) {' },
  { stage: 0, text: '    return Math.floor((childIndex - 1) / 2);' },
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  hasParent(childIndex) {' },
  { stage: 0, text: '    return this.getParentIndex(childIndex) >= 0;' },
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  parent(childIndex) {' },
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  heapifyUp(customStartIndex) {' },
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  swap(indexOne, indexTwo) {' },
