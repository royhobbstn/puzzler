...
export const data = {
  problemID: 30,
  problemName: `Implement the **peek* method for a MinHeap.`,
  problemText: `Implement a **peek** method that will return the value of the first (next-up) item in a Min Heap.`,
  testCases: [
    {
      id: 1,
      name: 'compiles',
