...
export const data = {
  problemID: 31,
  problemName: `Implement **find** for a MinHeap.`,
  problemText: `Implement a **find** method for a MinHeap that accepts a value (item) and returns an array of indices where the value is found in a MinHeap.`,
  testCases: [
    {
      id: 1,
      name: 'compiles',
