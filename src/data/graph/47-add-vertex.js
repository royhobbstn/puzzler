...
const solution = [
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  addVertex(key) {' },
  { stage: 0, text: '    const vertex = new Vertex(key);' },
  { stage: 0, text: '    this.vertices[key] = vertex;' },
  { stage: 0, text: '' },
  { stage: 0, text: '    if (!this.adjList[key]) {' },
  { stage: 0, text: '      this.adjList[key] = {};' },
  { stage: 0, text: '    }' },
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '}' },
