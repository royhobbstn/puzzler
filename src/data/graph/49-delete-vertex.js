...
const solution = [
  ...
  { stage: 0, text: '  }' },
  { stage: 0, text: '' },
  { stage: 0, text: '  deleteVertex(vertexKey) {' },
  { stage: 0, text: '    delete this.vertices[vertexKey];' },
  { stage: 0, text: '    delete this.adjList[vertexKey];' },
  { stage: 0, text: '    for (let key of Object.keys(this.adjList)) {' },
  { stage: 0, text: '      for (let vk of Object.keys(this.adjList[key])) {' },
  { stage: 0, text: '        if (vk === vertexKey) {' },
  { stage: 0, text: '          delete this.adjList[key][vk];' },
  { stage: 0, text: '        }' },
  { stage: 0, text: '      }' },
  { stage: 0, text: '    }' },
  { stage: 0, text: '  }' },
