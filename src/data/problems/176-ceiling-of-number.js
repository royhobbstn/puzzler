...
const solution = [
  ...
  { stage: 0, text: '' },
  { stage: -2, text: '  // arr is sorted.  if key is already greater than the last item' },
  { stage: -2, text: '  // return early, as there is not any ceiling' },
  ...
  { stage: 7, text: '    } else {' },
  { stage: -10, text: '      // the quick escape only happens if key === arrayValue' },
  ...
  {
    stage: -11,
    text: '  // the start index will point to the smallest number greater than the key',
  },
  {
    stage: -11,
    text: '  // the end index iterates needlessly on the last iteration of the while loop',
  },
  { stage: -11, text: '  // rendering it incorrect to return' },
