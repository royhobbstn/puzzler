...
const solution = [
  ...
  { stage: 0, text: '' },
  { stage: 0, text: "    // keep track of count of 1's only" },
  { stage: 3, text: '    if (arr[windowEnd] === 1) {' },
  { stage: 4, text: '      maxOnesCount += 1;' },
  { stage: 3, text: '    }' },
  { stage: 0, text: '' },
  { stage: 0, text: '    // if the length of the window, minus the count of ones' },
  { stage: 0, text: '    // is greater than max allowed number of replacements' },
  { stage: 0, text: '    // remove characters from beginning of substring' },
  { stage: 0, text: '    // until condition is met' },
